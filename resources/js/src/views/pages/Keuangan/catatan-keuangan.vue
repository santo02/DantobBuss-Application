<template>
  <div>
    ...
    <v-text-field type="date" label="Pilih tanggal" placeholder="Pilih Tanggal" v-model="selectedDate" style="width: 300px;" solo />
    <v-data-table :headers="headers" :items="filteredItems">
      ...
      <template #item.Detail="{ item }">
        <router-link :to="{ name: 'detail-catatan-keuangan', params: { tanggal: item.tanggal } }">
          Detail
        </router-link>
      </template>
    </v-data-table>
